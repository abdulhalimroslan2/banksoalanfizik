...
with open('scratch/t4_b4_answers_verified.json', 'r', encoding='utf-8') as f:
    ANSWERS = json.load(f)

with open('scratch/t4_b4_diagram_urls.json', 'r', encoding='utf-8') as f:
    DIAGRAM_URLS = json.load(f)

from scripts.build_b4_dataset import classify_dskp_b4

def make_b4_q(qid, no, aras, konstruk, soalan, pilihan, rajah_key="", sumber="Percubaan SPM 2023", tahun=2023):
    ...
    dskp = classify_dskp_b4(soalan, k_num)
...
print("make_b4_q helper defined.")
